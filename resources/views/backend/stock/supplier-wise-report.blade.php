                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="show_supplier" style="display: none;">
                                    <form method="GET" action="{{ route('stock.report.supplier.wise.pdf') }}"
                                        target="_blank" id="supplierWiseForm">
                                        <div class="form-row">
                                            <div class="col-sm-8">
                                ...
                                <div class="show_product" style="display: none;">
                                    <form method="GET" action="{{ route('stock.report.product.wise.pdf') }}" target="_blank"
                                        id="productWiseForm">
                                        <div class="form-row">
