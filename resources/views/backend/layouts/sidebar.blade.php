            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('supplier.view') }}"
                                class="nav-link {{ $route == 'supplier.view' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>View Supplier</p>
                            </a>
                        </li>
                ...
                <li class="nav-item  has-treeview" {{ $prefix == '/supplier' ? 'menu-open' : '' }}>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('customers.creadit') }}"
                                class="nav-link {{ $route == 'customers.creadit' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item  has-treeview" {{ $prefix == '/unit' ? 'menu-open' : '' }}>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('unit.view') }}"
                                class="nav-link {{ $route == 'unit.view' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>View Unit</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('product.view') }}"
                                class="nav-link {{ $route == 'product.view' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>View Product</p>
                            </a>
                        </li>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('purchase.report') }}"
                                class="nav-link {{ $route == 'purchase.report' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item  has-treeview" {{ $prefix == '/stock' ? 'menu-open' : '' }}>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('stock.report.supplier.wise') }}"
                                class="nav-link {{ $route == 'stock.report.supplier.wise' ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
