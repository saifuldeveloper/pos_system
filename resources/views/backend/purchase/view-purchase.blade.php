                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-primary">
                                    puchase list
                                    <a class="btn btn-primary float-right btn-sm" href="{{ route('purchase.add') }}"><i
                                            class="fa fa-plus-circle pr-3"></i>Add Purchase</a>
                                </h3>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                                ...
                                                <td>
                                                    @if ($purchase->status == '0')
                                                        <a href="{{ route('purchase.delete', $purchase->id) }}"
                                                            id="delete" class="btn btn-sm btn-danger " title="Delete"><i
