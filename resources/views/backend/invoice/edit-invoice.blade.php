          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3>
                Purchase  Edit
                  <a class="btn btn-info float-right btn-sm pl-3" href="{{ route('purchase.view') }}"><i class="fa fa-list pr-3"></i>Purchase list</a>
                </h3>
              </div><!-- /.card-header -->
              <div class="card-body">
                 <form method="post"  action="{{ route('purchase.update',$editData->id) }}" id="myForm" enctype="multipart/form-data">
                     @csrf
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-6 ">
                             ...
                             <input type="name" name="name" value="{{ $editData->name }}" id="name" class="form-control">
                         </div>
