                    ...
                    <section class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    Purchase Edit
                                    <a class="btn btn-info float-right btn-sm pl-3" href="{{ route('purchase.view') }}"><i
                                            class="fa fa-list pr-3"></i>Purchase list</a>
                                </h3>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form method="post" action="{{ route('purchase.update', $editData->id) }}" id="myForm"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <select name="unit_id" id="" class="form-control">
                                                ...
                                                @foreach ($unit as $item)
                                                    <option value="{{ $item->id }}"
                                                        {{ $editData->unit_id == $item->id ? 'selected' : '' }}>
                                                        {{ $item->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6 ">
                                            ...
                                            <input type="name" name="name" value="{{ $editData->name }}" id="name"
                                                class="form-control">
                                        </div>
