                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="text-primary">
                                    ...
                                    <a class="btn btn-primary float-right btn-sm" href="{{ route('customers.add') }}"><i
                                            class="fa fa-plus-circle pr-3"></i>Add Customers</a>
                                </h3>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                        ...
                                        @foreach ($allData as $key => $customers)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('customers.delete', $customers->id) }}" id="delete"
