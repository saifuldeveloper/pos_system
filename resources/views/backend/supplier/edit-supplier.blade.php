                    ...
                    <section class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    Supplier Edit
                                    <a class="btn btn-info float-right btn-sm pl-3" href="{{ route('supplier.view') }}"><i
                                            class="fa fa-list pr-3"></i>Supplier list</a>
                                </h3>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form method="post" action="{{ route('supplier.update', $editData->id) }}" id="myForm"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-8  m-auto">
                                            ...
                                            <input type="text" name="mobile" id="mobile" value="{{ $editData->mobile }}"
                                                class="form-control">
                                        </div>
                                        <div class="form-group col-md-8  m-auto">
