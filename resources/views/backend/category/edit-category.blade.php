        ...
        <section class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3>
                Category Edit
                <a class="btn btn-info float-right btn-sm pl-3" href="{{ route('supplier.view') }}"><i class="fa fa-list pr-3"></i>Cateogry list</a>
              </h3>
            </div><!-- /.card-header -->
            <div class="card-body">
              <form method="post" action="{{ route('category.update',$editData->id) }}" id="myForm" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
