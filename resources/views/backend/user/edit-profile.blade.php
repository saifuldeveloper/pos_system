                    ...
                    <section class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3>
                                    Edit Profile
                                    <a class="btn btn-success float-right btn-sm pl-3"
                                        href="{{ route('profiles.view') }}"><i class="fa fa-user"></i>Your Profile</a>
                                </h3>
                            </div><!-- /.card-header -->
                            <div class="card-body">
                                <form method="post" action="{{ route('profiles.update') }}" id="myForm"
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="mobile" name="mobile" value="{{ $editData->mobile }}" id="mobile"
                                                class="form-control">
                                            <font style="color: red">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="address" name="address" value="{{ $editData->address }}"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select name="gender" id="gender" class="form-control">
                                                ...
                                                <option value="Female" {{ $editData->gender == 'User' ? 'Female' : '' }}>Female
                                                </option>
                                            </select>
                                            <font style="color: red">
                                        ...
                                        <div class="form-group col-md-4">
                                            <img id="showImage"
                                                src="{{ !empty($editData->image) ? asset('upload/user_images/' . $editData->image) : asset('upload/no.png') }}"
                                                alt="" style="width:150px;height:160px; border:1px solid #000;">
                                        </div>
